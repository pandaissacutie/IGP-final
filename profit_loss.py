...
def profitloss_function():
    ...
    statement= []
     # A for loop is created to loop the second item's position to the last items's position of the net profit list 
    ...
    # The difference between current net profit and previous net profit is calculated by substracting them with each other and assigned to a variable called diff
